...
if (is_dir("$app_root/modules/contrib/environment_indicator") && isset($settings['enabled_config_overrides']) && in_array('environment_indicator', $settings['enabled_config_overrides'])) {
...
// ### SMTP
if (is_dir("$app_root/modules/contrib/smtp") && isset($settings['enabled_config_overrides']) && in_array('smtp', $settings['enabled_config_overrides'])) {
...
// ### Redis
if (is_dir("$app_root/modules/contrib/redis") && isset($settings['enabled_config_overrides']) && in_array('redis', $settings['enabled_config_overrides']) && $settings['disable_cache'] === FALSE) {
...
// ### Seckit
if (is_dir("$app_root/modules/contrib/seckit") && isset($settings['enabled_config_overrides']) && in_array('seckit', $settings['enabled_config_overrides'])) {
  ...
  $config['seckit.settings']['seckit_ssl']['hsts'] = $settings['seckit_hsts_enabled'];
  $config['seckit.settings']['seckit_various']['disable_autocomplete'] = $settings['seckit_various_disable_autocomplete'];
}
